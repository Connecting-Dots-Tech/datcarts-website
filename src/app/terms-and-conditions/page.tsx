...
const RelatedQuestions = () => (
  <nav className="legal-related" aria-label="Related questions">
    ...
    <ul>
      ...
      <li>
        <a href="#ownership">Ownership and property</a>
      </li>
      <li>
        <a href="#privacy">Privacy and data usage</a>
      </li>
      <li>
        <a href="#account">Account responsibilities</a>
      </li>
      <li>
        <a href="#platform-role">Platform role and limitations</a>
      </li>
      <li>
        <a href="#facilitator">We are a facilitator</a>
      </li>
      <li>
        <a href="#product-warranty">Product warranty disclaimer</a>
      </li>
      <li>
